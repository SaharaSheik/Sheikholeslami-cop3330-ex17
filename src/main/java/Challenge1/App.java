...
public class App {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Enter total alcohol consumed: ");
        ...
        System.out.print("Were the values entered in Metric or Imperial? ");
        check = input.nextLine();

        double BAC  = check.toUpperCase().equals("METRIC")? ((((consumedAlcohol*0.035274) * 5.14) / ((bodyWeight*2.20) * ratio)) - (0.015 * numHours))
        :(((consumedAlcohol * 5.14) / (bodyWeight * ratio)) - (0.015 * numHours));
